...
/// 支持横向或竖向摆放按钮
/// 横向最多摆放两个按钮
class DrsAlertDialog extends StatelessWidget {
  /// 横向按钮排列的对话框
  ///
  /// [leftBtn]和[rightBtn]不传style参数会应用默认样式，左侧弱按钮，右侧强按钮
  const DrsAlertDialog({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    return DrsDialogScaffold(
        ...
        body: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const DrsDivider(height: 24, color: Colors.transparent),
